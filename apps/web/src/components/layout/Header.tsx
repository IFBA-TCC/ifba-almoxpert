  ...
  return (
    <header className="bg-white border-b border-gray-100 px-4 sm:px-6 py-4 flex items-center gap-4 sticky top-0 z-20">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <button aria-label="Notificações" className="w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:bg-gray-100 relative transition-colors">
          <Bell size={18} />
        </button>
